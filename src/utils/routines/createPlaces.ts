...
var _brasil: Place[] = [
  ...
  new Place("Amazonas", [
    ...
    new Profession("Índios"),
    new Profession("Floresta"),
  ...
  new Place("Grandes Atletas", [
    new Profession("Pelé"),
    new Profession("Ayrton Senna"),
    new Profession("Anderson Silva"),
    new Profession("Ronaldinho Gaúcho"),
    new Profession("Ronaldo Fenômeno"),
    new Profession("Marta"),
    new Profession("César Cielo"),
    new Profession("Gustavo Kuerten (Guga)"),
  ]),
  new Place("Comidas Brasileiras", [
    new Profession("Feijoada"),
    new Profession("Brigadeiro"),
    new Profession("Pão de Queijo"),
    new Profession("Feijão Tropeiro"),
    new Profession("Tapioca"),
    new Profession("Cuscuz"),
    new Profession("Acarajé"),
  ]),
  new Place("Festas / Feriados", [
    new Profession("Carnaval"),
    new Profession("Festa Junina"),
    new Profession("7 de Setembro"),
    new Profession("12 de Outubro"),
    new Profession("Natal"),
  ]),
  new Place("Cantores / Músicos", [
    new Profession("Tom Jobim"),
    new Profession("Tim Maia"),
    new Profession("Luiz Gonzaga"),
    new Profession("Raul Seixas"),
    new Profession("Renato Russo"),
    new Profession("Chorão"),
    new Profession("Vinícius de Moraes"),
    new Profession("Mano Brown"),
    new Profession("Rita Lee"),
    new Profession("Matuê"),
    new Profession("Felipe Ret"),
    new Profession("Luisa Sonza"),
  ]),
  ...
  new Place("Personalidades", [
    new Profession("Pelé"),
    new Profession("Oscar Niemeyer"),
    new Profession("Ayrton Senna"),
    new Profession("Tom Jobim"),
    new Profession("Whindersson"),
    new Profession("Mano Brown"),
    new Profession("Anitta"),
    new Profession("Gusttavo Lima"),
    new Profession("Ronaldinho"),
  ]),
  new Place("Gêneros Musicais", [
    new Profession("Samba"),
    new Profession("Bossa Nova"),
    new Profession("MPB"),
    new Profession("Forró"),
    new Profession("Sertanejo"),
    new Profession("Pagode"),
    new Profession("Axé"),
    new Profession("Funk"),
  ]),
  ...
  new Place("Animais Brasileiros", [
    new Profession("Boto-cor-de-rosa"),
    new Profession("Mico-leão-dourado"),
    new Profession("Arara-azul"),
    new Profession("Onça-pintada"),
    new Profession("Sucuri"),
    new Profession("Capivara"),
  ]),
  new Place("Eventos Históricos", [
    new Profession("Descobrimento do Brasil"),
    new Profession("Independência"),
    new Profession("Abolição da Escravatura"),
    new Profession("Proclamação da República"),
    new Profession("Ditadura Militar"),
    new Profession("Diretas Já"),
  ]),
];
...
var _diversos: Place[] = [
  ...
  new Place("Comidas", [
    ...
    new Profession("Feijoada"),
    new Profession("Sopa"),
    new Profession("Pizza"),
    new Profession("Hamburger"),
    new Profession("Tacos"),
    new Profession("Coxinha"),
  ]),
  new Place("Países", [
    new Profession("Brasil"),
    new Profession("Estados Unidos"),
    new Profession("China"),
    new Profession("Rússia"),
    new Profession("Japão"),
    new Profession("Índia"),
    new Profession("Argentina"),
    new Profession("Alemanha"),
    new Profession("Portugal"),
  ]),
  new Place("Idiomas", [
    new Profession("Portugues"),
    new Profession("Inglês"),
    new Profession("Alemão"),
    new Profession("Japão"),
    new Profession("Japones"),
    new Profession("Espanhol"),
    new Profession("Latim"),
  ]),
  new Place("Raças de Cachorro", [
    new Profession("Pastor Alemão"),
    new Profession("Bulldog"),
    new Profession("Pitbull"),
    new Profession("Shih Tzu"),
    new Profession("Pug"),
    new Profession("Salsicha"),
    new Profession("Golden"),
    new Profession("Viralata"),
    new Profession("Husky"),
  ]),
  new Place("Moedas", [
    new Profession("Dolar"),
    new Profession("Real"),
    new Profession("Euro"),
    new Profession("Libra esterlina"),
    new Profession("Bitcoin"),
  ]),
  new Place("Dias da semana", [
    new Profession("Domingo"),
    new Profession("Segunda"),
    new Profession("Terça"),
    new Profession("Quarta"),
    new Profession("Quinta"),
    new Profession("Sexta"),
    new Profession("Sábado"),
  ]),
  new Place("Meses do Ano", [
    new Profession("Janeiro"),
    new Profession("Fevereiro"),
    new Profession("Março"),
    new Profession("Abril"),
    new Profession("Maio"),
    new Profession("Junho"),
    new Profession("Julho"),
    new Profession("Agosto"),
    new Profession("Setembro"),
    new Profession("Outubro"),
    new Profession("Novembro"),
    new Profession("Dezembro"),
  ]),
]